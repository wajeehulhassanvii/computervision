...
# Loading the dataset
dataset = dset.CIFAR10(root = '../datasets/gan_cifar10/data', download = True, transform = transform) # We download the training set in the ./data folder and we apply the previous transformations on each image.
